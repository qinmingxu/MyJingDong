...
public class CartsAdapter extends BaseExpandableListAdapter {
    ...
    public CartsAdapter(Context con, LinearLayout cart_empty, List<MessageBean.DataBean> groupList, List<List<MessageBean.DataBean.ListBean>> childList) {
        this.con=con;
    ...
    public View getChildView(final int i, final int i1, boolean b, View view, ViewGroup viewGroup) {
        ...
        holder.cbChild.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                PriceAndNum priceAndCountEvent = compute();
...
//        GoosBean.DataBean dataBean = groupList.get(groupPosition);
    ...
    private PriceAndNum compute() {
        ...
        PriceAndNum priceAndCountEvent = new PriceAndNum();
